...
const CashBookLedger = () => {
    ...
    const fetchLedgerData = async () => {
        try {
            ...
            const response = await axios.get(`${API_BASE_URL}/get-cash-ledger-details/?account_code=${accountCode}`, {
                headers: {
            ...
            if (response.data.success) {
                ...
                console.log('Date range:', {
                    from: threeDaysAgo.toDateString(),
        ...
        <div className="all-body">
            <div className="debtors-container">
                ...
                {!loading && ledgerData.length === 0 && !error && (
                    <p className="no-data">No ledger entries found for this cash account in the last 3 days.</p>
                )}
